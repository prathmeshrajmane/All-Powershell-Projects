...
$json = Invoke-WebRequest -Uri 'http://localhost:9096/crumbIssuer/api/json' -Headers $Headers
...
Invoke-WebRequest -Uri "http://localhost:9096/job/Shared%20Library/build" -Headers $BuildHeaders -Method Post